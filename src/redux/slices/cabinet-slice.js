...
let initialState = {
  ...
  insuredEvent: {
    ...
    textLink: "Заявление на получение страховой выплаты",
    documentLink:
  ...
  deduction: {
    ...
    docs: [
      {
        id: Math.random(),
        textLink: 'Памятка для клиента о социальном налоговом вычете',
        documentLink: 'https://prolife.ru/static/upload/iblock/510/pamyatka_nalogoviy_vichet.pdf'
      },
      {
        id: Math.random(),
        textLink: 'Заявление о выдаче справки о подтверждении неполучения налогоплательщиком социального налогового вычета',
        documentLink: 'https://prolife.ru/static/upload/statements/8_Spravka_o_podtverzhdenii_nepolucheniya_soc_nalogovogo_vicheta.pdf'
      }
    ],
    items: [
      {
        ...
        listTitle: 'Налоговый вычет удастся получить, если ваша страховка удовлетворяет определенным условиям. Необходимо заключить договор на длительное время, по меньшей мере, на 5 лет. Оформить страховку можно для следующих лиц:',
        subInfo: 'Купив подходящий полис, можно подать заявку на получение вычета.',  
        list: [
      ...
      },
      {
        ...
        listTitle: 'Какие документы для налогового вычета за страхование жизни вам потребуются:',
        subInfo: 'При оформлении вычета на ребенка, супруга, родителей необходим документ, который подтверждает родство. Это свидетельство о рождении (ваше или детей) и о браке.',
        list: [
      ...
      },
      {
        ...
        subInfo: 'За деньгами можно обратиться либо в налоговую службу, либо к своему работодателю. В первом случае деньги просто должны вернуться вам на счет, во втором работодатель имеет право выдать следующую зарплату без удержания НДФЛ. У него есть три месяца, чтобы вернуть излишние средства, которые были вычтены из зарплаты. Налоговая обычно переводит деньги через 30−90 дней после подачи заявления.'
      }
    ]
  },
  policies: {
    docs: {
      textLink: 'Заявление на внесение изменений в полис',
      documentLink: 'https://prolife.ru/static/upload/statements/5_Zayavlenie_na_vnesenie_izmeneniy_v_polis.pdf',
    }
  },
  programs: {
    ...
    items: [
      {
        ...
        shortInfo: 'программа накопительного страхования, с единовременной выплатой.',
        docs: '/docs/programs/nb.zip'
      },
      {
        id: Math.random(),
        name: 'НАДЕЖНОЕ БУДУЩЕЕ ДЕТЯМ',
        shortInfo: 'программа накопительного страхования для детей, с единовременной выплатой.',
      ...
      },
      {
        id: Math.random(),
        name: 'НС ПЛЮС',
        shortInfo: 'программа страхования от несчастных случаев для всей семьи.',
        docs: '/docs/programs/nsp.zip'
      },
      {
        id: Math.random(),
        name: 'НЕПОСЕДЫ',
        shortInfo: 'программа страхования от несчастных случаев и болезней для детей от 1 до 17 лет включительно.',
        docs: '/docs/programs/neposedy.zip'
      },
      {
        id: Math.random(),
        name: 'ЗАЩИТА+',
        shortInfo: 'программа страхования от несчастных случаев с дополнительным сервисом – «Телемедицина».',
        docs: '/docs/programs/defence_plus.zip'
      },
      {
        id: Math.random(),
        name: 'ЗДОРОВЬЕ',
        shortInfo: 'оперативная финансовая помощь застрахованным лицам в случае постановки диагноза смертельно опасного заболевания',
        docs: 'https://prolife.ru/static/upload/program_health.pdf'
      },
      {
        id: Math.random(),
        name: 'ДМС',
        shortInfo: 'программа, позволяющая обеспечить более высокий уровень медицинской помощи себе и близким',
        docs: 'https://www.sberbank.ru/common/img/uploaded/pdf/dms/%D0%BE%D0%B1%D1%80%D0%B0%D0%B7%D0%B5%D1%86_%D0%BF%D0%BE%D0%BB%D0%B8%D1%81%D0%B0.pdf'
      }
    ]
  }
};
