...
let initialState = {
  title: {
    ...
    imgSrc: "/assets/imgs/cabinet/roofing.svg",
  },
  menu: {
    items: [
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/profile.svg", 
        content: "Профиль",
        to: "profile",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/career.svg",
        content: "Карьера",
        to: "career",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/notification.svg",
        content: "Сообщения",
        to: "messages",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/news.png",
        content: "Новости",
        to: "news",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/energy.svg",
        content: "Cтраховой случай",
        to: "insuredEvent",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/tax-calculate.svg",
        content: "Получить вычет",
        to: "deduction",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/copy.svg",
        content: "Полисы",
        to: "policies",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/pie-chart.svg",
        content: "Программы",
        to: "programs",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/cardboard-box.svg",
        content: "Архивы",
        to: "archives",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/credit-card.svg",
        content: "Оплатить",
        to: "payment",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/calculate.svg",
        content: "Калькулятор",
        to: "calculate",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/send.svg",
        content: "Направить заявление",
        to: "sendStatement",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/question.svg",
        content: "Задать вопрос",
        to: "askQuestion",
      },
      {
        id: Math.random(),
        imgSrc: "/assets/imgs/cabinet/menu/id-card.svg",
  ...
  career: {
    ourTeam: {
      ...
      team: [
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/m2.jpg",
        ...
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/m1.jpg",
        ...
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/w1.jpg",
        ...
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/m3.jpg",
        ...
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/w2.jpg",
        ...
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/w3.jpg",
        ...
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/m4.jpg",
        ...
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/w4.jpg",
        ...
        {
          id: Math.random(),
          avatar: "/assets/imgs/cabinet/career/team/m5.jpg",
